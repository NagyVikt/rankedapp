...
import { gridIconSvg, gridSnippetHtml, gridPreviewHtml } from './previews/grid';
import {
  headingIconSvg,
  headingSnippetHtml,
  headingPreviewHtml,
} from './previews/heading';
import { linkIconSvg, linkSnippetHtml, linkPreviewHtml } from './previews/link';
import {
  imageIconSvg,
  imageSnippetHtml,
  imagePreviewHtml,
...
import { textIconSvg, textSnippetHtml, textPreviewHtml } from './previews/text';
