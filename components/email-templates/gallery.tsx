    ...
    return (
      <Html lang="en" dir="ltr">
        <Head>
          ...
          <link rel="preload" as="image" href="/static/stagg-electric-kettle.jpg" />
          ...
          <Container style={{ maxWidth: "600px", width: "100%" }}>
            ...
            <Section>
              ...
              >
                ...
                award-winning home brew grinder. From the finest pour-overs to the coarsest
                cold brews, your coffee will never be the same again.
              </Text>
            </Section>
