  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-small font-medium mb-1">Consumer Key</label>
          <Input value={ck} onChange={e => onCkChange(e.target.value)} placeholder="ck_xxxxx" />
        </div>
        <div>
          <label className="block text-small font-medium mb-1">Consumer Secret</label>
          <Input value={cs} onChange={e => onCsChange(e.target.value)} placeholder="cs_xxxxx" />
        </div>
      </div>
      <div>
        <label className="block text-small font-medium mb-1">Select Webshop</label>
        <select
