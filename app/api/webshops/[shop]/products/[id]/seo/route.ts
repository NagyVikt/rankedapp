// app/api/webshops/[shop]/products/[id]/seo/route.ts
...
export async function POST(
  ...
  // 3) build your SEO prompt exactly as before...
  const prompt = `
...
"""
`;
  //with this model temprature is unsupported
  ...
  // 4) inject our priceComparison block
  if (priceComparison) {
