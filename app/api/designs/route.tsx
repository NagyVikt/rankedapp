      ...
      cookies: {
        ...
        set(name: string, value: string, options: CookieOptions) {
          try {
            ...
            // user sessions.
            console.warn(`Failed to set cookie '${name}' from Server Component/Route Handler:`, error)
          }
        },
        remove(name: string, options: CookieOptions) {
          try {
            ...
            // This can be ignored if you have middleware refreshing
            // user sessions.
             console.warn(`Failed to remove cookie '${name}' from Server Component/Route Handler:`, error)
          }
        },
      },
    }
