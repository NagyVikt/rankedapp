...
export default async function RootLayout({
  ...
  // Get the current pathname from the headers to conditionally render the Navbar
  const pathname = hdrs.get('x-invoke-path') || '/'; // Use x-invoke-path for Next.js App Router
          ...
          <SidebarProvider>
            ...
            <DeepResearchProvider>
              ...
              {/*
                ...
                Only show the Navbar if the current pathname is NOT '/start'.
              */}
