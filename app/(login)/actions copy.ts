...
// Assuming getTeamForUser returns something like: { user: User; teamId: number | null; role: string | null; team: Team | null }
...
export async function signOut() {
  try {
    ...
    if (user) {
      const userWithTeam = await getTeamForUser(user.id)
